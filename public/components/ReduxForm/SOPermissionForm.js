            ...
            <div className="row">
                <div className="col-md-6 col-md-offset-3">
                    ...
                    <div className="text-right">
                        <button type="button" className="btn btn-primary" onClick={props._save.bind(this,'SO_OP')}>保 存</button>
                    </div>
                </div>
            </div>
...
SOPermissionForm = reduxForm({
    form: 'SOPermissionForm'  // a unique identifier for this form
})(SOPermissionForm)
SOPermissionForm = connect(
    state => ({
        initialValues: state.getSysManagerPermissionList.data.permissionInfo // pull initial values from account reducer
    })         // bind account loading action creator
)(SOPermissionForm)

export default SOPermissionForm
