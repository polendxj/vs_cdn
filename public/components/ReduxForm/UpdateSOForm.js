...
UpdateSOForm = reduxForm({
    form: 'UpdateSOForm'  // a unique identifier for this form
})(UpdateSOForm)

UpdateSOForm = connect(
    state => ({
        initialValues: state.soDetail.data // pull initial values from account reducer
    })         // bind account loading action creator
)(UpdateSOForm)

export default UpdateSOForm
