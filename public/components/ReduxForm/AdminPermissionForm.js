            ...
            <div className="row">
                <div className="col-md-6 col-md-offset-3">
                    ...
                    <div className="text-right">
                        <button type="button" className="btn btn-primary" onClick={props._save.bind(this,'SV')}>保 存</button>
                    </div>
                </div>
            </div>
...
AdminPermissionForm = reduxForm({
    form: 'AdminPermissionForm'  // a unique identifier for this form
})(AdminPermissionForm)
AdminPermissionForm = connect(
    state => ({
