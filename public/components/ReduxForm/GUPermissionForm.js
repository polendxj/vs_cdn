            ...
            <div className="row">
                <div className="col-md-6 col-md-offset-3">
                    ...
                    <div className="text-right">
                        <button type="button" className="btn btn-primary" onClick={props._save.bind(this,'GU')}>保 存</button>
                    </div>
                </div>
            </div>
...
GUPermissionForm = reduxForm({
    form: 'GUPermissionForm'  // a unique identifier for this form
})(GUPermissionForm)
GUPermissionForm = connect(
    state => ({
        initialValues: state.getSysManagerPermissionList.data.permissionInfo // pull initial values from account reducer
    })         // bind account loading action creator
)(GUPermissionForm)

export default GUPermissionForm
