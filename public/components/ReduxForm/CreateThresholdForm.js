                            ...
                            <div className="col-md-4 col-md-offset-4">
                                <div className="form-group">
                                    ...
                                    <div className="col-lg-9">
                                        <Field className="form-control" name="thresholdName" component="input"
                                               type="text"
                                ...
                                <div className="form-group">
                                    <label className="col-lg-3 control-label"
                                           style={{textAlign: 'center'}}>{Current_Lang.status.minor}</label>
                                ...
                                <div className="form-group">
                                    <label className="col-lg-3 control-label"
                                           style={{textAlign: 'center'}}>{Current_Lang.status.major}</label>
                                    <div className="col-lg-5">
                                ...
                                <div className="form-group">
                                    <label className="col-lg-3 control-label"
                                           style={{textAlign: 'center'}}>{Current_Lang.status.critical}</label>
                                    <div className="col-lg-5">
                                ...
                                <div className="form-group">
                                    <label className="col-lg-3 control-label"
                                           style={{textAlign: 'center'}}>{Current_Lang.status.fatal}</label>
                                    <div className="col-lg-5">
